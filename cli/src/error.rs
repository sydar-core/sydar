...
use sydar_wallet_core::error::Error as WalletError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] sydar_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] sydar_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] sydar_daemon::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] sydar_bip32::Error),

    #[error("private key {0} already exists")]
    PrivateKeyAlreadyExists(String),

    #[error(transparent)]
    MetricsError(sydar_metrics_core::error::Error),

    #[error(transparent)]
    sydarWalletKeys(#[from] sydar_wallet_keys::error::Error),

    #[error(transparent)]
    PskbLockScriptSigError(#[from] sydar_wallet_pskt::error::Error),
