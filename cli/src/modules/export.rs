use crate::imports::*;
use sydar_wallet_core::account::{Account, BIP32_ACCOUNT_KIND, MULTISIG_ACCOUNT_KIND, multisig::MultiSig};
...
async fn export_multisig_account(ctx: Arc<sydarCli>, account: Arc<MultiSig>) -> Result<()> {
...
async fn export_single_key_account(ctx: Arc<sydarCli>, account: Arc<dyn Account>) -> Result<()> {
