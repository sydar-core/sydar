...
use sydar_addressmanager::{AddressManager, NetAddress};
use sydar_core::{debug, info, warn};
use sydar_p2p_lib::{ConnectionError, Peer, common::ProtocolError};
...
pub struct ConnectionManager {
    p2p_adaptor: Arc<sydar_p2p_lib::Adaptor>,
...
impl ConnectionManager {
    ...
    async fn handle_outbound_connections(self: &Arc<Self>, peer_by_address: &HashMap<SocketAddr, Peer>) {
        let active_outbound: HashSet<sydar_addressmanager::NetAddress> =
