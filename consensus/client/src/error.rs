...
pub enum Error {
    ...
    #[error(transparent)]
    ScriptBuilder(#[from] sydar_txscript::script_builder::ScriptBuilderError),
    ...
    #[error(transparent)]
    Dilithium(#[from] sydar_dilithium::DilithiumError),

    #[error(transparent)]
    Sign(#[from] sydar_consensus_core::sign::Error),
    ...
    #[error(transparent)]
    CompressedParents(#[from] sydar_consensus_core::errors::header::CompressedParentsError),
