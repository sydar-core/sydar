//!
//! # Standardized JSON serialization and deserialization of sydar transactions.
//!
//! This module provides standardized JSON serialization and deserialization of
//! sydar transactions. There are two sub-modules: `numeric` and `string`.
//!
...
//! For more advanced use cases, please refer to `PSKT` in the [`sydar_wallet_pskt`](https://docs.rs/sydar_wallet_pskt)
//! crate.
//!
