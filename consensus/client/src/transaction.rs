//!
//! Declares the client-side [`Transaction`] type, which represents a sydar transaction.
//!
...
use sydar_consensus_core::network::NetworkTypeT;
use sydar_consensus_core::subnets::{self, SubnetworkId};
use sydar_consensus_core::tx::UtxoEntry;
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<sydar_addresses::AddressArrayT> {
