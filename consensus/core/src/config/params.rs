...
impl BlockrateParams {
    pub const fn new<const BPS: u64>() -> Self {
        Self {
            ...
            sydar_consensus_k: Bps::<BPS>::sydar_consensus_k(),
...
impl Params {
    ...
    pub fn sydar_consensus_k(&self) -> KType {
        self.blockrate.sydar_consensus_k
    }
    ...
    pub fn anticone_finalization_depth(&self) -> u64 {
        let anticone_finalization_depth = self.blockrate.finality_depth
            + self.blockrate.merge_depth
            + 4 * self.blockrate.mergeset_size_limit * self.blockrate.sydar_consensus_k as u64
            + 2 * self.blockrate.sydar_consensus_k as u64
            + 2;
...
pub const TESTNET_PARAMS: Params = Params {
    dns_seeders: &[
        ...
        "seeder1-testnet.sydard.net",
        // This DNS seeder is run by -gerri-
        "dnsseeder-sydar-testnet.x-con.at",
        // This DNS seeder is run by supertypo
        "n-testnet-10.sydar.ws",
    ],
