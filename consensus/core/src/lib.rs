...
//! # Consensus Core
//!
//! This crate implements primitives used in the sydar node consensus processing.
//!
...
pub type BlueWorkType = sydar_math::Uint192;
...
/// The type used to represent the sydar_CONSENSUS K parameter
pub type KType = u16;
