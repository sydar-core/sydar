...
// `sydar_wallet_core::tx::mass::MassCalculator`
#[derive(Clone)]
...
mod tests {
    use super::*;
    use crate::{
        constants::{KANA_PER_sydar, STORAGE_MASS_PARAMETER},
        network::NetworkType,
        ...
        */
        let test_cases = vec![
            ...
            PluralityTestCase {
                ...
                inputs_tx1: &[1000 * KANA_PER_sydar],
                outputs_tx1: &[200 * KANA_PER_sydar, 200 * KANA_PER_sydar, 200 * KANA_PER_sydar],
                inputs_tx2: &[1000 * KANA_PER_sydar],
                outputs_tx2: &[200 * KANA_PER_sydar, 400 * KANA_PER_sydar],
                plurality_index: Some(1),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                ...
                inputs_tx1: &[1000 * KANA_PER_sydar],
                outputs_tx1: &[200 * KANA_PER_sydar, 200 * KANA_PER_sydar],
                inputs_tx2: &[1000 * KANA_PER_sydar],
                outputs_tx2: &[400 * KANA_PER_sydar],
                plurality_index: Some(0),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                ...
                inputs_tx1: &[350 * KANA_PER_sydar, 500 * KANA_PER_sydar],
                outputs_tx1: &[200 * KANA_PER_sydar, 200 * KANA_PER_sydar],
                inputs_tx2: &[350 * KANA_PER_sydar, 500 * KANA_PER_sydar],
                outputs_tx2: &[400 * KANA_PER_sydar],
                plurality_index: Some(0),
                desired_plurality: Some(2),
                override_output: true,
            ...
            PluralityTestCase {
                ...
                inputs_tx1: &[350 * KANA_PER_sydar, 500 * KANA_PER_sydar, 350 * KANA_PER_sydar, 500 * KANA_PER_sydar],
                outputs_tx1: &[
                    200 * KANA_PER_sydar,
                    200 * KANA_PER_sydar,
                    400 * KANA_PER_sydar,
                ...
                inputs_tx2: &[350 * KANA_PER_sydar, 500 * KANA_PER_sydar, 350 * KANA_PER_sydar, 500 * KANA_PER_sydar],
                outputs_tx2: &[200 * KANA_PER_sydar, 200 * KANA_PER_sydar, 400 * KANA_PER_sydar, 750 * KANA_PER_sydar],
    ...
    fn test_storage_mass() {
        ...
        let base_value = 10_000 * KANA_PER_sydar;
        ...
        tx2.tx.outputs[0].value = 10 * KANA_PER_sydar;
