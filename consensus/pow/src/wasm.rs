...
use js_sys::BigInt;
use num::Float;
use sydar_consensus_client::Header;
use sydar_consensus_client::HeaderT;
use sydar_consensus_core::hashing;
use sydar_hashes::Hash;
use sydar_hashes::PowHash;
use sydar_math::Uint256;
use sydar_utils::hex::FromHex;
...
/// Represents a sydar header PoW manager
/// @category Mining
...
// https://github.com/tmrlvi/sydar-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L36
...
/// <https://github.com/tmrlvi/sydar-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L375>
/// @category Mining
