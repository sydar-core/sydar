...
use crate::{
    ...
    model::{
        ...
        stores::{
            ...
            sydar_consensus::DbsydarConsensusStore, selected_chain::DbSelectedChainStore, statuses::DbStatusesStore,
        },
    },
    processes::{
        block_depth::BlockDepthManager, coinbase::CoinbaseManager, parents_builder::ParentsManager, pruning::PruningPointManager,
        pruning_proof::PruningProofManager, sydar_consensus::protocol::sydarConsensusManager, sync::SyncManager,
...
pub type DbsydarConsensusManager = sydarConsensusManager<
...
pub type DbDagTraversalManager =
    DagTraversalManager<DbsydarConsensusStore, DbReachabilityStore, MTRelationsService<DbRelationsStore>>;

pub type DbWindowManager = SampledWindowManager<DbsydarConsensusStore, BlockWindowCacheStore, DbHeadersStore, DbDaaStore>;
...
>;
pub type DbBlockDepthManager = BlockDepthManager<DbDepthStore, DbReachabilityStore, DbsydarConsensusStore, DbHeadersStore>;
...
pub struct ConsensusServices {
    ...
    pub sydar_consensus_manager: DbsydarConsensusManager,
...
impl ConsensusServices {
    pub fn new(
        ...
        let dag_traversal_manager = DagTraversalManager::new(
            params.genesis.hash,
            storage.sydar_consensus_store.clone(),
        ...
        let sydar_consensus_manager = sydarConsensusManager::new(
            params.genesis.hash,
