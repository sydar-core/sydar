...
use sydar_consensus_core::{BlockHasher, BlockLevel, header::Header};
use sydar_database::prelude::{BatchDbWriter, CachedDbAccess};
use sydar_database::prelude::{CachePolicy, DB};
use sydar_database::prelude::{StoreError, StoreResult};
...
struct Header2 {
    ...
    pub nonce: u64,
    pub daa_score: u64,
    pub blue_work: sydar_consensus_core::BlueWorkType,
    pub blue_score: u64,
