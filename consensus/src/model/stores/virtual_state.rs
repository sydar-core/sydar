...
use sydar_consensus_core::api::stats::VirtualStateStats;
...
use sydar_database::prelude::{BatchDbWriter, CachedDbItem, DirectDbWriter, StoreResultExt};
use sydar_database::prelude::{CachePolicy, StoreResult};
use sydar_database::prelude::{DB, StoreError};
use sydar_database::registry::DatabaseStorePrefixes;
use sydar_hashes::Hash;
use sydar_muhash::MuHash;
use serde::{Deserialize, Serialize};

use super::sydar_consensus::sydarConsensusData;
use std::collections::HashMap;

#[derive(Clone, Serialize, Deserialize, Default)]
pub struct VirtualState {
    pub parents: Vec<Hash>,
    pub sydar_consensus_data: sydarConsensusData,
    pub daa_score: u64,
    pub bits: u32,
...
impl VirtualState {
    ...
    pub fn from_genesis(genesis: &GenesisBlock, sydar_consensus_data: sydarConsensusData) -> Self {
        Self {
    ...
    pub fn to_virtual_state_approx_id(&self) -> VirtualStateApproxId {
        VirtualStateApproxId::new(self.daa_score, self.sydar_consensus_data.blue_work, self.sydar_consensus_data.selected_parent)
    }
}
