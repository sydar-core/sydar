...
mod tests {
    ...
    use crate::{
        ...
        errors::RuleError,
        model::stores::sydar_consensus::sydarConsensusStoreReader,
    ...
    async fn validate_body_in_context_test() {
...

        {
            ...
            let valid_block_child_gd = consensus.sydar_consensus_store().get_data(valid_block_child.header.hash).unwrap();
