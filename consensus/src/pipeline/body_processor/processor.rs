use crate::{
    ...
    model::{
        ...
        stores::{
            ...
            sydar_consensus::DbsydarConsensusStore,
...
pub struct BlockBodyProcessor {
    ...
    pub(super) _sydar_consensus_k: KType,

    // Stores
    pub(super) statuses_store: Arc<RwLock<DbStatusesStore>>,
    pub(super) _sydar_consensus_store: Arc<DbsydarConsensusStore>,
...
impl BlockBodyProcessor {
    pub fn new(
        ...
        Self {
            ...
            _sydar_consensus_k: params.sydar_consensus_k(),

            statuses_store: storage.statuses_store.clone(),
            _sydar_consensus_store: storage.sydar_consensus_store.clone(),
