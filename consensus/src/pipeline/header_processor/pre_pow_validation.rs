...
impl HeaderProcessor {
    ...
    fn check_difficulty_and_daa_score(&self, ctx: &mut HeaderProcessingContext, header: &Header) -> BlockProcessResult<()> {
        ...
        let daa_window = self.window_manager.block_daa_window(sydar_consensus_data)?;
        ...
        let expected_bits = self.window_manager.calculate_difficulty_bits(sydar_consensus_data, &daa_window);
