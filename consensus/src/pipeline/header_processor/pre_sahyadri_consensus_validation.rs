...
use sydar_consensus_core::blockhash::BlockHashExtensions;
use sydar_consensus_core::blockstatus::BlockStatus::StatusInvalid;
...
impl HeaderProcessor {
    ...
    fn check_pow_and_calc_block_level(&self, header: &Header) -> BlockProcessResult<BlockLevel> {
        let state = sydar_pow::State::new(header);
