...
use sydar_consensus_core::hashing::sighash::SigHashReusedValues;
    ...
    opcode OpCheckLockTimeVerify<0xb0, 1>(self, vm) {
        match vm.script_source {
            ScriptSource::TxInput {input, tx, ..} => {
                ...
                // condition would result in the transaction being allowed into the sydarDAG
...
mod test {
    ...
    use sydar_consensus_core::constants::{KANA_PER_sydar, TX_VERSION};
    ...
    mod kip10 {
        ...
        use sydar_consensus_core::tx::MutableTransaction;
