...
use sydar_consensus_core::tx::{ScriptPublicKey, ScriptPublicKeyVersion};
...
/// Standard classes of script payment in the sydarDAG
...
#[cfg(test)]
mod tests {
    use sydar_consensus_core::tx::ScriptVec;
