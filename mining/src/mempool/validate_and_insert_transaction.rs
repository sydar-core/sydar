...
impl Mempool {
    ...
    pub(crate) fn post_validate_and_insert_transaction(
        ...
        // =====================================================================
        // sydar 100% ANTI-SPAM SHIELD: ZERO-PENDING VIP RULE
        // =====================================================================
        ...
        if pending_count >= 50 {
            debug!("sydar Anti-Spam: Sender {} reached max 50 pending txs. Dropping.", sender_address);
        ...
        if is_emergency_mode && pending_count > 0 {
            debug!("sydar Emergency Mode: Dropping tx from {} to save space for Normal Users.", sender_address);
            return Err(RuleError::RejectInvalid(transaction_id));
        }
        // =====================================================================
