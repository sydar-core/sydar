...
use sydar_consensusmanager::ConsensusProxy;
...
use sydar_p2p_lib::{
    ...
    pb::{RequestTransactionsMessage, TransactionNotFoundMessage, sydard_message::Payload},
};
use std::sync::Arc;
...
impl RelayTransactionsFlow {
    ...
    pub fn invs_channel_size() -> usize {
        ...
        // Note: in go-sydard we have 10,000 for this channel combined with tx channel.
        4096
    }
