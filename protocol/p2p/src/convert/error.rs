use sydar_consensus_core::subnets::SubnetworkConversionError;
use thiserror::Error;
...
pub enum ConversionError {
    ...
    #[error("Bytes size mismatch error {0}")]
    UintBytesSizeError(#[from] sydar_math::uint::TryFromSliceError),
    ...
    #[error(transparent)]
    CompressedParentsError(#[from] sydar_consensus_core::errors::header::CompressedParentsError),
}
