use crate::{
    IncomingRoute, Router, sydardMessagePayloadType,
    common::ProtocolError,
    core::adaptor::ConnectionInitializer,
    handshake::sydardHandshake,
    pb::{self, VersionMessage},
};
use sydar_core::{debug, time::unix_now, trace, warn};
use std::sync::Arc;
...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            sydardMessagePayloadType::Addresses,
            sydardMessagePayloadType::Block,
            sydardMessagePayloadType::Transaction,
            sydardMessagePayloadType::BlockLocator,
            sydardMessagePayloadType::RequestAddresses,
            sydardMessagePayloadType::RequestRelayBlocks,
            sydardMessagePayloadType::RequestTransactions,
            sydardMessagePayloadType::IbdBlock,
            sydardMessagePayloadType::InvRelayBlock,
            sydardMessagePayloadType::InvTransactions,
            sydardMessagePayloadType::Ping,
            sydardMessagePayloadType::Pong,
            // sydardMessagePayloadType::Verack,
            // sydardMessagePayloadType::Version,
            // sydardMessagePayloadType::Ready,
            sydardMessagePayloadType::TransactionNotFound,
            sydardMessagePayloadType::Reject,
            sydardMessagePayloadType::PruningPointUtxoSetChunk,
            sydardMessagePayloadType::RequestIbdBlocks,
            ...
            sydardMessagePayloadType::RequestNextHeaders,
            sydardMessagePayloadType::DoneHeaders,
            sydardMessagePayloadType::RequestPruningPointUtxoSet,
            sydardMessagePayloadType::RequestHeaders,
            sydardMessagePayloadType::RequestBlockLocator,
            sydardMessagePayloadType::PruningPoints,
            sydardMessagePayloadType::RequestPruningPointProof,
            ...
            sydardMessagePayloadType::RequestIbdChainBlockLocator,
            sydardMessagePayloadType::IbdChainBlockLocator,
            sydardMessagePayloadType::RequestAntipast,
    ...
    async fn call(&self, msg: pb::sydardMessage) -> bool {
        // echo
...
fn build_dummy_version_message() -> VersionMessage {
    pb::VersionMessage {
        ...
        subnetwork_id: None,
        network: "sydar-mainnet".to_string(),
    }
}
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        //
        // Example code to illustrate sydar P2P handshaking
        //

        // Build the handshake object and subscribe to handshake messages
        let mut handshake = sydardHandshake::new(&router);
...
mod tests {
    ...
    use sydar_utils::networking::NetAddress;

    #[tokio::test]
    async fn test_handshake() {
        sydar_core::log::try_init_logger("debug");
