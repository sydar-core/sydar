...
pub enum RpcApiOps {
    ...
    GetSyncStatus = 115,
    /// Returns the network this sydard is connected to (Mainnet, Testnet)
    ...
    /// Returns a list of all the addresses (IP, port) this sydard knows and a list of all addresses that are currently banned by this sydard
    ...
    /// Returns a list of the peers currently connected to this sydard, along with some statistics on them
    GetConnectedPeerInfo = 123,
    /// Instructs sydard to connect to a given IP address.
    AddPeer = 124,
