...
use sydar_utils::networking::IpAddress;
...
pub enum RpcError {
    ...
    #[error(transparent)]
    AddressError(#[from] sydar_addresses::AddressError),

    #[error(transparent)]
    NetworkTypeError(#[from] sydar_consensus_core::network::NetworkTypeError),

    #[error(transparent)]
    NetworkIdError(#[from] sydar_consensus_core::network::NetworkIdError),

    #[error(transparent)]
    NotificationError(#[from] sydar_notify::error::Error),

    #[error(transparent)]
    MiningManagerError(#[from] sydar_mining_errors::manager::MiningManagerError),

    #[error(transparent)]
    ConsensusError(#[from] sydar_consensus_core::errors::consensus::ConsensusError),

    #[error(transparent)]
    ScriptClassError(#[from] sydar_txscript::script_class::Error),
