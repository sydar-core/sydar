//! # RPC Core
//!
//! This crate provides foundational primitives used in sydar node RPC subsystem.
...
//!
//! This crate acts as a foundation for [`sydar_grpc_client`](https://docs.rs/sydar_grpc_client) and
//! [`sydar_wrpc_client`](https://docs.rs/sydar_wrpc_client) crates, which provide gRPC and WebSocket
//! RPC client implementations. This crate is also used by WASM bindings to provide [WASM RpcClient
//! implementation](https://docs.rs/sydar-wrpc-client/latest/sydar_wrpc_client/wasm/struct.RpcClient.html)
//! (based on wRPC).
//!
