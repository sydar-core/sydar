...
use sydar_utils::{hex::ToHex, serde_bytes_fixed_ref};
...
/// Represents the ID of a sydar transaction
...
/// Represents a sydar transaction outpoint
...
impl From<sydar_consensus_client::TransactionOutpoint> for RpcTransactionOutpoint {
    fn from(outpoint: sydar_consensus_client::TransactionOutpoint) -> Self {
        TransactionOutpoint::from(outpoint).into()
    }
}

impl From<RpcTransactionOutpoint> for sydar_consensus_client::TransactionOutpoint {
    fn from(outpoint: RpcTransactionOutpoint) -> Self {
        TransactionOutpoint::from(outpoint).into()
    }
}
...
/// Represents a sydar transaction input
...
/// Represent sydar transaction input verbose data
...
/// Represents a sydard transaction output
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represent sydar transaction output verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represents a sydar transaction
#[derive(Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represent sydar transaction verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
