use crate::{
    error::{Error, Result},
    resolver::{Resolver, sydardResponseReceiver, sydardResponseSender},
};
...
impl Pending {
    fn new(sender: sydardResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: sydardPayloadOps, request: &sydardRequest) -> sydardResponseReceiver {
