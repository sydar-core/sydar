...
from!(item: &sydar_rpc_core::RpcBalancesByAddressesEntry, protowire::RpcBalancesByAddressesEntry, {
...
try_from!(item: &protowire::RpcBalancesByAddressesEntry, sydar_rpc_core::RpcBalancesByAddressesEntry, {
