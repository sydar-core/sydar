...
from!(item: &sydar_rpc_core::RpcFeerateBucket, protowire::RpcFeerateBucket, {
    Self {
...
from!(item: &sydar_rpc_core::RpcFeeEstimate, protowire::RpcFeeEstimate, {
    Self {
...
from!(item: &sydar_rpc_core::RpcFeeEstimateVerboseExperimentalData, protowire::RpcFeeEstimateVerboseExperimentalData, {
    Self {
...
try_from!(item: &protowire::RpcFeerateBucket, sydar_rpc_core::RpcFeerateBucket, {
    Self {
        feerate: item.feerate,
        estimated_seconds: item.estimated_seconds,
    }
...
try_from!(item: &protowire::RpcFeeEstimate, sydar_rpc_core::RpcFeeEstimate, {
    Self {
...
try_from!(item: &protowire::RpcFeeEstimateVerboseExperimentalData, sydar_rpc_core::RpcFeeEstimateVerboseExperimentalData, {
    Self {
        network_mass_per_second: item.network_mass_per_second,
        mempool_ready_transactions_count: item.mempool_ready_transactions_count,
        mempool_ready_transactions_total_mass: item.mempool_ready_transactions_total_mass,
