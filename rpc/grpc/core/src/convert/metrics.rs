...
from!(item: &sydar_rpc_core::ConnectionsProfileData, protowire::ConnectionsProfileData, {
    Self {
...
from!(item: &sydar_rpc_core::ProcessMetrics, protowire::ProcessMetrics, {
    Self {
...
from!(item: &sydar_rpc_core::ConnectionMetrics, protowire::ConnectionMetrics, {
    Self {
...
from!(item: &sydar_rpc_core::BandwidthMetrics, protowire::BandwidthMetrics, {
    Self {
...
from!(item: &sydar_rpc_core::ConsensusMetrics, protowire::ConsensusMetrics, {
    Self {
...
from!(item: &sydar_rpc_core::StorageMetrics, protowire::StorageMetrics, {
    Self {
...
try_from!(item: &protowire::ConnectionsProfileData, sydar_rpc_core::ConnectionsProfileData, {
    Self { cpu_usage : item.cpu_usage as f32, memory_usage : item.memory_usage }
});

try_from!(item: &protowire::ProcessMetrics, sydar_rpc_core::ProcessMetrics, {
    Self {
        resident_set_size: item.resident_set_size,
        virtual_memory_size: item.virtual_memory_size,
        core_num: item.core_num,
...
try_from!(item: &protowire::ConnectionMetrics, sydar_rpc_core::ConnectionMetrics, {
    Self {
        borsh_live_connections: item.borsh_live_connections,
        borsh_connection_attempts: item.borsh_connection_attempts,
        borsh_handshake_failures: item.borsh_handshake_failures,
...
try_from!(item: &protowire::BandwidthMetrics, sydar_rpc_core::BandwidthMetrics, {
    Self {
        borsh_bytes_tx: item.borsh_bytes_tx,
        borsh_bytes_rx: item.borsh_bytes_rx,
        json_bytes_tx: item.json_bytes_tx,
...
try_from!(item: &protowire::ConsensusMetrics, sydar_rpc_core::ConsensusMetrics, {
    Self {
...
try_from!(item: &protowire::StorageMetrics, sydar_rpc_core::StorageMetrics, {
    Self {
        storage_size_bytes: item.storage_size_bytes,
    }
});
