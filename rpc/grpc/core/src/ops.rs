use crate::protowire::{sydard_request::Payload as RequestPayload, sydard_response::Payload as ResponsePayload, *};
...
pub enum sydardPayloadOps {
    ...
    // The conversion from a notification ResponsePayload into sydardPayloadOps fails.
}
}
