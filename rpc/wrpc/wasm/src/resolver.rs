//! [`Resolver`](NativeResolver) bindings for obtaining public sydar wRPC URL endpoints.
...
use crate::imports::*;
use js_sys::Array;
pub use sydar_rpc_macros::declare_typescript_wasm_interface as declare;
use sydar_wrpc_client::Resolver as NativeResolver;
use sydar_wrpc_client::node::NodeDescriptor;
use serde::ser;
...
///
/// Resolver is a client for obtaining public sydar wRPC URL.
///
/// Resolver queries a list of public sydar Resolver URLs using HTTP to fetch
...
#[wasm_bindgen]
impl Resolver {
    /// List of public sydar Resolver URLs.
    #[wasm_bindgen(getter)]
    ...
    /// Fetches a public sydar wRPC endpoint for the given encoding and network identifier.
    ...
    /// Fetches a public sydar wRPC endpoint URL for the given encoding and network identifier.
    ...
    /// Connect to a public sydar wRPC endpoint for the given encoding and network identifier
