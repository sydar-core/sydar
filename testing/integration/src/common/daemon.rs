...
use sydar_core::{core::Core, signals::Shutdown, task::runtime::AsyncRuntime};
...
use sydar_utils::triggers::Listener;
use sydard_lib::{args::Args, daemon::create_core_with_runtime};
use std::{ops::Deref, sync::Arc, time::Duration};
use tempfile::TempDir;

use sydar_grpc_client::ClientPool;
...
impl Daemon {
    ...
    pub fn with_manager(client_manager: Arc<ClientManager>, fd_total_budget: i32) -> Daemon {
        let appdir_tempdir = get_sydar_tempdir();
