...
use sydar_consensus_core::trusted::TrustedBlock;
use sydar_consensus_core::tx::{TransactionOutpoint, UtxoEntry};
use serde::{Deserialize, Serialize};

pub use sydar_consensus_core::trusted::ExternalsydarConsensusData as JtfsydarConsensusData;
pub use sydar_rpc_core::{
...
pub struct JtfTrustedBlock {
    pub block: JtfBlock,
    pub sydar_consensus: JtfsydarConsensusData,
}
...
pub fn json_line_to_trusted_block(line: String) -> TrustedBlock {
    ...
    TrustedBlock::new(block, jtf_trusted_block.sydar_consensus)
}
