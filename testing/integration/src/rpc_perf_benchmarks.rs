...
/// `cargo test --release --package sydar-testing-integration --lib --features devnet-prealloc -- rpc_perf_benchmarks::bench_rpc_high_load --exact --nocapture --ignored`
#[tokio::test]
#[ignore = "bmk"]
...
async fn bench_rpc_high_load() {
    ...
    let dag_info = main_client.get_sydar_dag_info().await.unwrap();
    ...
    for _ in 0..num_clients {
        ...
        let handle = tokio::spawn(async move {
            ...
            for _ in 0..num_requests_per_client {
                ...
                client
                    .get_virtual_chain_from_block_v2(*hash, Some(sydar_rpc_core::RpcDataVerbosityLevel::High), None)
                    .await
                    .unwrap();
