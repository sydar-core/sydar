//!
//! Legacy (KDX, sydarnet.io Web Wallet) account implementation
//!
...
use crate::imports::*;
use sydar_bip32::{ExtendedPrivateKey, Prefix, SecretKey};

const CACHE_ADDRESS_OFFSET: u32 = 2048;

pub const LEGACY_ACCOUNT_KIND: &str = "sydar-legacy-standard";
...
impl Factory for Ctor {
    ...
    fn description(&self) -> String {
        "sydar Legacy Account (KDX, sydarnet.io Web Wallet)".to_string()
    }
