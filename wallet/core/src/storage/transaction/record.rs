...
pub use sydar_consensus_core::tx::TransactionId;
use zeroize::Zeroize;
...
export enum TransactionDataType {
    /**
     * Transaction has been invalidated due to a sydarDAG reorganization.
 ...
 * that has been invalidated due to a sydarDAG reorganization.
 * @category Wallet SDK
 */
...
/**
 * Transaction record generated by the sydar Wallet SDK.
