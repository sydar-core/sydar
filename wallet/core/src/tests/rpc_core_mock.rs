...
use sydar_notify::events::EVENT_TYPE_ARRAY;
use sydar_notify::listener::{ListenerId, ListenerLifespan};
use sydar_notify::notifier::{Notifier, Notify};
use sydar_notify::scope::Scope;
...
use sydar_rpc_core::api::ctl::RpcCtl;
use sydar_rpc_core::{RpcResult, notify::connection::ChannelConnection};
use sydar_rpc_core::{api::connection::DynRpcConnection, api::rpc::RpcApi, *};
use std::sync::Arc;
...
impl RpcCoreMock {
    ...
    #[allow(dead_code)]
    pub fn notify_new_block_template(&self) -> sydar_notify::error::Result<()> {
...
impl RpcApi for RpcCoreMock {
    ...
    ) -> Result<sydar_rpc_core::SubmitAccountTransactionResponse, sydar_rpc_core::RpcError> {
        unimplemented!()
    }

    async fn submit_account_transaction_call(
        &self,
        _request: Option<&std::sync::Arc<dyn sydar_rpc_core::api::connection::RpcConnection>>,
        _req: sydar_rpc_core::SubmitAccountTransactionRequest,
    ) -> Result<sydar_rpc_core::SubmitAccountTransactionResponse, sydar_rpc_core::RpcError> {
        unimplemented!()
    }
    ...
    async fn get_sydar_dag_info_call(
        &self,
        _connection: Option<&DynRpcConnection>,
        _request: GetsydarDagInfoRequest,
