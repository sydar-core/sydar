...
use sydar_consensus_core::network::NetworkIdT;
use sydar_wallet_macros::declare_typescript_wasm_interface as declare;
use sydar_wasm_core::events::{Sink, get_event_targets};
use sydar_wrpc_wasm::{IConnectOptions, Resolver, RpcClient, RpcConfig, WrpcEncoding};
...
///
/// The sydar is developed in Rust, and the Wallet class is a Rust implementation
