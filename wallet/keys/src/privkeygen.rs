...
/// This class accepts the master sydar XPrv string (e.g. `xprv1...`) and generates
...
///
/// Please note that in sydar master private keys use `kprv` prefix.
///
