//!
//! Partially Signed sydar Transaction (PSKT)
//!

use sydar_bip32::{DerivationPath, DilithiumPkHash, KeyFingerprint};
use sydar_consensus_core::Hash;
...
use sydar_consensus_core::mass::{MassCalculator, NonContextualMasses};
...
pub struct KeySource {
    #[serde(with = "sydar_utils::serde_bytes_fixed")]
...
///
/// A Partially Signed sydar Transaction (PSKT) is a standardized format
/// that allows multiple participants to collaborate in creating and signing
/// a sydar transaction. PSKT enables the exchange of incomplete transaction
