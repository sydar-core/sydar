let sydar = require('../../../../nodejs/sydar');
let {
    PrivateKey,
    PublicKey,
    PublicKeyGenerator,
...
// Getting sydar Address from Private Key
...
function demoGenerateAddressFromPublicKeyHexString() {
    ...
    console.info(publicKey.toAddress(NetworkType.Mainnet).toString() == 'sydar:qr0lr4ml9fn3chekrqmjdkergxl93l4wrk3dankcgvjq776s9wn9jkdskewva');
    ...
    console.info(xOnlyPublicKey.toAddress(NetworkType.Mainnet).toString() == 'sydar:qr0lr4ml9fn3chekrqmjdkergxl93l4wrk3dankcgvjq776s9wn9jkdskewva');
    ...
    console.info(fullDERPublicKey.toAddress(NetworkType.Mainnet).toString() == 'sydar:qqs7krzzwqfgk9kf830smtzg64s9rf3r0khfj76cjynf2pfgrr35saatu88xq');
}