...
(async () => {
    ...
    console.info(`Full sydar address: ${sourceAddress}`);
    ...
    if (!entries.length) {
        ...
        //
        // If the requested amount is greater than the sydar
        ...
        let generator = new Generator({
            entries,
            outputs: [{ address : sourceAddress, amount : sydarToKana(0.2)}],
            priorityFee: sydarToKana(0.0001),
