...
use sydar_consensus::{consensus::Consensus, params::OverrideParams};
use sydar_consensus_core::{api::ConsensusApi, block::Block};
use sydar_testing_integration::common::json::JtfBlock;
...
pub(crate) fn write_blocks_json(params: &Params, consensus: &Consensus, file_path: &str) {
    ...
    write_sydard_params(params, &mut writer);
...
fn write_sydard_params<W: Write>(params: &Params, writer: &mut W) {
